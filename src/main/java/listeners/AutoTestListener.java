...
public class AutoTestListener extends TestListenerAdapter {
	...
	public void onFinish(ITestContext testContext) {
        ...
        Iterator<ITestResult> listOfFailedTests = testContext.getFailedTests().getAllResults().iterator(); 
         ...
         ExtentTestNGIReporterListener.allTests=testContext.getAllTestMethods().length;
         ExtentTestNGIReporterListener.failTests=testContext.getFailedTests().getAllMethods().size();
